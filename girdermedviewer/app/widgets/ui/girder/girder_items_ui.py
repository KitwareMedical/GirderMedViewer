...
class GirderItemsUI(html.Div):
    ...
    def __init__(self, **kwargs):
        ...
        self.item_card.download_canceled.connect(self.download_canceled)
        self.item_card.setting_window.item_deleted.connect(self.item_deleted)
        self.item_card.setting_window.item_settings.setting_changed.connect(self.setting_changed)
